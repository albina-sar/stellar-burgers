...
- Name: constructor.spec.ts >> Страница конструктора бургера >> должен закрывать модальное окно по клику на крестик
- Location: tests\constructor.spec.ts:80:7
...
- generic [ref=e3]:
  - banner [ref=e4]:
    - navigation [ref=e5]:
      - generic [ref=e6]:
        - link "Конструктор" [ref=e7]:
          - /url: /
          - img [ref=e8]
          - paragraph [ref=e10]: Конструктор
        - link "Лента заказов" [ref=e11]:
          - /url: /feed
          - img [ref=e12]
